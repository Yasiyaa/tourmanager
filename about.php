	...
	<section class="testemonial">
		<div class="container team-cont">
			...
			<div class="gallary-header text-center">
				<h2>
					Our team and work done by each member
				</h2>
					...
					<div class="home1-testm-single text-center">
						...
						<div class="home1-testm-txt">
							...
							<p style="text-align:center;">
								Edit front end , login form php coding.
								Book now form php coding.Delete bookings php coding.
				...
				<div class="home1-testm item">
					<div class="home1-testm-single text-center">
						...
						<div class="home1-testm-txt">
							...
							<p style="text-align:center;">
								Loging form validation,Register form validations
							</p>
							<h3>
								<a>
									Ayon
				...
				<div class="home1-testm item">
					<div class="home1-testm-single text-center">
						...
						<div class="home1-testm-txt">
							...
							<p style="text-align:center;">
								Database create and register form php coding.
							</p>
							<h3>
								<a>
									Sharanga
				...
				<div class="home1-testm item">
					<div class="home1-testm-single text-center">
						...
						<div class="home1-testm-txt">
							...
							<p style="text-align:center;">
								Booking form update bookings php coding. Book now form front end create.
							</p>
							<h3>
								<a>
									Ruchira
				...
				<div class="home1-testm item">
					<div class="home1-testm-single text-center">
						...
						<div class="home1-testm-txt">
							...
							<p style="text-align:center;">
								Destination form create.Destinations table with php coding.
							</p>
							<h3>
								<a>
									Janidu
				...
				<div class="home1-testm item">
					<div class="home1-testm-single text-center">
						...
						<div class="home1-testm-txt">
							...
							<p style="text-align:center;">
								Recreate about us page. Adding content and arrange the page.
							</p>
							<h3>
								<a>
									Yuwani
					...
					<div class="col-sm-3">
						<div class="single-footer-item">
							...
							<div class="single-footer-txt">
								<p>Ayon Fernando</p>
								<p>Ashen Sharanga</p>
								<p>Ruchira Amarasingha</p>
								<p>Janidu Ratnayake</p>
								<p>Yuwani Sathsara</p>
								<p>yasith Vidusara</p>
					...
					<div class="col-sm-3">
						<div class="single-footer-item text-center">
							...
							<div class="single-footer-txt text-left">
								<p>0712570137</p>
								<p class="foot-email"><a href="#">CodeArt@gmail.com</a></p>
								<p>NIBM</p>
								<p>Colombo</p>
							</div>
							<!--/.single-footer-txt-->
